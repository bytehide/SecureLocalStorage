...
namespace SecureLocalStorage
{
    public class SecureLocalStorage : ISecureLocalStorage
    {
        ...
        internal byte[] EncryptData(string data, byte[] key, DataProtectionScope scope)
        {
            ...
            else return Encoding.UTF8.GetBytes(AESThenHMAC.SimpleEncryptWithPassword(data, Encoding.UTF8.GetString(key)));
        }
        ...
        internal string DecryptData(byte[] data, byte[] key, DataProtectionScope scope)
        {
            ...
            else return AESThenHMAC.SimpleDecryptWithPassword(Encoding.UTF8.GetString(data), Encoding.UTF8.GetString(key));
        ...
        #region Linux and MacOS encryption
